    ...
    //     { name: '天津', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" }}}, 
    // { name: '上海', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '重庆', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '河北', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '河南', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '云南', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '辽宁', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '黑龙江', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '湖南', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '安徽', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '山东', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } },
    // { name: '新疆', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '江苏', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '浙江', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '江西', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '湖北', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '广西', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '甘肃', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '山西', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '内蒙古', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '陕西', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '吉林', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '福建', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '贵州', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } },
    // { name: '广东', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '青海', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '西藏', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '四川', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '宁夏', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '海南', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '台湾', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '香港', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }, 
    // { name: '澳门', itemStyle: {normal: {borderWidth: .5,shadowBlur: 0, shadowColor: 'rgba(0, 0, 0, 0.2)',areaColor: "rgba(0, 0, 0)"} ,emphasis: {borderWidth: .8,areaColor: "#ffdead" } } }]
    var all_info = [];
    var option = {
